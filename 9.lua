...
-- FIX: แก้ไขการเช็ค Platform ไม่ให้เรียกใช้ UserInputService:GetPlatform() ที่ไม่มีจริง
...
-- FIX: ปรับการดักหา Parent เพื่อความเสถียรทั้งใน Studio และ Executor
