...
-- GitHub Raw URL Standalone Framework WITH COLORPICKER, SEARCH, SETTINGS TAB & DISCORD BUTTON
...
function Library:CreateWindow(config)
    ...
    -- Controls & Persistent Discord Button
    ...
    DiscordIcon.ImageColor3 = Color3.fromRGB(88, 101, 242) -- Discord Blue Accent
    ...
    DiscordBtn.MouseButton1Click:Connect(function()
        ...
        Library:Notify("Discord", "Copied Discord Link to Clipboard!", 3, "Success")
    end)

    local MinimizeBtn = Instance.new("TextButton")
    MinimizeBtn.Size = UDim2.new(0, 32, 0, 32)
    MinimizeBtn.Position = UDim2.new(0, 40, 0.5, -16)
