...
if not guiParent then
    guiParent = CoreGui or (LocalPlayer and LocalPlayer:FindFirstChild("PlayerGui"))
end
...
function Library:CreateWindow(config)
    ...
    TxtDisplayName.Text = LocalPlayer and LocalPlayer.DisplayName or "Guest"
    ...
    TxtUsername.Text = "@" .. (LocalPlayer and LocalPlayer.Name or "Guest")
    ...
    function WindowObj:CreateTab(tabConfig)
        ...
        local isSettings = type(tabConfig) == "table" and tabConfig.IsSettings or false
        local TabObj = {}
