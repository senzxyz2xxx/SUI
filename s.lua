...
-- GitHub Raw URL Standalone Framework WITH DISCORD PERSISTENT BUTTON ON PROFILE SIDE
...
function Library:PlaySplash(onComplete, windowSize)
    ...
    OverlayStroke.Color = self.Theme.Border
...
function Library:CreateWindow(config)
    ...
    HeaderTitleFrame.Size = UDim2.new(0, 240, 1, 0)
    ...
    -- ==========================================
    -- DISCORD PERSISTENT BUTTON (PROFILE SIDE)
    -- ==========================================
    local DiscordBtn = Instance.new("TextButton")
    DiscordBtn.Name = "DiscordPersistentBtn"
    DiscordBtn.Size = UDim2.new(0, 32, 0, 32)
    DiscordBtn.Position = UDim2.new(0, 300, 0, 10)
    DiscordBtn.BackgroundColor3 = self.Theme.BG_Surface
    DiscordBtn.Text = ""
    DiscordBtn.Parent = TopBar
    Instance.new("UICorner", DiscordBtn).CornerRadius = UDim.new(0, 6)

    local DiscordStroke = Instance.new("UIStroke")
    DiscordStroke.Color = self.Theme.Border
    DiscordStroke.Thickness = 1
    DiscordStroke.Parent = DiscordBtn

    local DiscordIcon = Instance.new("ImageLabel")
    DiscordIcon.Size = UDim2.new(0, 18, 0, 18)
    DiscordIcon.Position = UDim2.new(0.5, -9, 0.5, -9)
    DiscordIcon.Image = "rbxassetid://12128796836"
    DiscordIcon.ImageColor3 = Color3.fromRGB(88, 101, 242) -- Discord Brand Color
    DiscordIcon.BackgroundTransparency = 1
    DiscordIcon.Parent = DiscordBtn

    -- Hover Effect
    DiscordBtn.MouseEnter:Connect(function()
        TweenService:Create(DiscordBtn, TweenInfo.new(0.2), {BackgroundColor3 = Library.Theme.BG_Container}):Play()
        TweenService:Create(DiscordStroke, TweenInfo.new(0.2), {Color = Color3.fromRGB(88, 101, 242)}):Play()
    end)
    DiscordBtn.MouseLeave:Connect(function()
        TweenService:Create(DiscordBtn, TweenInfo.new(0.2), {BackgroundColor3 = Library.Theme.BG_Surface}):Play()
        TweenService:Create(DiscordStroke, TweenInfo.new(0.2), {Color = Library.Theme.Border}):Play()
    end)

    -- OnClick Clipboard & Notify
    ...
    function WindowObj:CreateTab(tabConfig)
        ...
        -- REAL-TIME SEARCH BAR FOR EVERY TAB
        ...
        function TabObj:AddSection(secTitle)
            ...
            -- REAL-TIME COLOR PICKER COMPONENT
    ...
    -- ==========================================
    -- 3. ALWAYS-LAST SETTINGS TAB CREATION
    -- ==========================================
